class CurrentAffairsRunner
{
	public static void main(String[] args)
	{
		...
		CurrentAffairs.cabinetMinisters(ministers);
		CurrentAffairs.primeMinistersOfIndia(primeMinisters);
		String[] parties={"Congress","AAAam Aadmi Party","BJP","National People's Party","Bahujan Samaj Party"};
		CurrentAffairs.politicalparties(parties);
	}
