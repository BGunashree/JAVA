...
public class StreamRunner {
	...
	public static void main(String[] args) {
		...
		collection.add(8951144517L);
		collection.add(8660084035L);
		collection.add(8951144679L);
		collection.add(9739611655L);
		collection.add(8904733310L);
		collection.add(9876543210L);
		collection.add(9977654329L);
		collection.add(7896543210L);
		collection.add(8864790321L);
		collection.add(8951144025L);
		...
		collection.stream().sorted((ref1,ref2)->ref2.compareTo(ref1)).collect(Collectors.toList()).forEach((ref)->System.out.println(ref));
		System.out.println("-----------------------------------------------------------------------------------");
		...
		collection.stream().sorted((ref1,ref2)->{
			if(ref2>ref1)
				...
				return -1;
			 return 0;}).collect(Collectors.toList()).forEach((ref)->System.out.println(ref));
